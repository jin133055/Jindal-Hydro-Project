        ...
        <div class="hero-img-wrap">
          <div class="baler-stage" id="balerStage" aria-label="Interactive 3D hydraulic baler model" role="img" tabindex="0">
            ...
            <div class="baler-model" id="balerModel">
              ...
              <div class="baler-cuboid baler-chamber">
                <span class="face front"></span><span class="face back"></span><span class="face right"></span><span class="face left"></span><span class="face top"></span><span class="face bottom"></span>
              </div>
              <div class="baler-cuboid baler-hopper">
                <span class="face front"></span><span class="face back"></span><span class="face right"></span><span class="face left"></span><span class="face top"></span><span class="face bottom"></span>
              </div>
              <div class="baler-cuboid baler-door">
                <span class="face front"></span><span class="face back"></span><span class="face right"></span><span class="face left"></span><span class="face top"></span><span class="face bottom"></span>
              </div>
              <div class="baler-cuboid baler-powerpack">
                <span class="face front"></span><span class="face back"></span><span class="face right"></span><span class="face left"></span><span class="face top"></span><span class="face bottom"></span>
              </div>
              <div class="baler-cuboid baler-rear-housing">
                <span class="face front"></span><span class="face back"></span><span class="face right"></span><span class="face left"></span><span class="face top"></span><span class="face bottom"></span>
              </div>
              <div class="baler-cylinder baler-cylinder-main"></div>
              <div class="baler-cylinder baler-cylinder-rod"></div>
              <div class="baler-cylinder baler-cylinder-main baler-cylinder-main-2"></div>
              <div class="baler-cylinder baler-cylinder-rod baler-cylinder-rod-2"></div>
              <div class="baler-cap baler-cap-1"></div>
              <div class="baler-cap baler-cap-2"></div>
              <div class="baler-cuboid baler-ram">
                <span class="face front"></span><span class="face back"></span><span class="face right"></span><span class="face left"></span><span class="face top"></span><span class="face bottom"></span>
              </div>
              <div class="baler-cuboid baler-feed-table">
                <span class="face front"></span><span class="face back"></span><span class="face right"></span><span class="face left"></span><span class="face top"></span><span class="face bottom"></span>
              </div>
              <div class="baler-cuboid baler-output-chute">
                <span class="face front"></span><span class="face back"></span><span class="face right"></span><span class="face left"></span><span class="face top"></span><span class="face bottom"></span>
              </div>
              <div class="baler-cuboid baler-control">
                <span class="face front"></span><span class="face back"></span><span class="face right"></span><span class="face left"></span><span class="face top"></span><span class="face bottom"></span>
              </div>
              <div class="baler-hydraulic-lines"></div>
              <div class="baler-front-cage">
                <span></span><span></span><span></span><span></span><span></span>
              </div>
              <div class="baler-side-handle baler-side-handle-left"></div>
              <div class="baler-side-handle baler-side-handle-right"></div>
              <div class="baler-upright baler-upright-1"></div>
              <div class="baler-upright baler-upright-2"></div>
              <div class="baler-rear-vent"></div>
              <div class="baler-rear-guard"></div>
              <div class="baler-rear-pipe baler-rear-pipe-1"></div>
    ...
    <div class="section-inner">
      ...
      <div class="products-grid">
        <a class="product-card reveal" href="/products/balers/super-jumbo-baler/">
          <div class="product-img"><img src="/images/3D%20Models%20from%20AI/Balers/01_Super Jumbo Baler.webp" alt="High Density Baler"></div>
        ...
        <a class="product-card reveal reveal-delay-1" href="/products/balers/automatic-baler/">
          <div class="product-img"><img src="/images/3D Models from AI/Balers/08_Automatic_Baler_Hero_Angle_v1.webp" alt="Automatic Baler"></div>
          <div class="product-body">
        ...
        <a class="product-card reveal reveal-delay-2" href="/products/material-recovery-facility/material-recovery-facility//">
          <div class="product-img"><img src="/images/3D%20Models%20from%20AI/19_MSW_Sorting_Line_v1.webp" alt="Installation and Training"></div>
          <div class="product-body">
    ...
    <div class="section-inner">
      ...
      <div class="why-grid">
        ...
        <div class="why-card reveal reveal-delay-1">
          <div class="why-icon">
            <svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><circle cx="12" cy="12" r="3"></circle><path d="M19.07 4.93l-1.41 1.41M5.34 17.66l-1.41 1.41M2 12h2M20 12h2M19.07 19.07l-1.41-1.41M5.34 6.34l-1.41-1.41M12 2v2M12 20v2"></path></svg>
          </div>
          <div class="why-title">Global Deployment Network</div>
          <div class="why-desc">Active installations across 40+ countries, with dedicated after-sales support and spare part logistics.</div>
        </div>
        ...
        <div class="why-card reveal reveal-delay-1">
          <div class="why-icon">
            <svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="9" y1="13" x2="15" y2="13"></line></svg>
          </div>
          <div class="why-title">ISO-Certified Manufacturing</div>
          <div class="why-desc">Manufacturing processes certified to international standards, ensuring consistency, safety, and durability.</div>
        </div>
        <div class="why-card reveal reveal-delay-2">
          <div class="why-icon" style="color: var(--green);">
            <svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="#22C55E" stroke-width="1.5"><path d="M5 12s2.545-5 7-5c4.454 0 7 5 7 5s-2.546 5-7 5c-4.455 0-7-5-7-5z"></path><circle cx="12" cy="12" r="3"></circle></svg>
          </div>
          <div class="why-title">Eco-Efficient by Design</div>
          <div class="why-desc">Machines engineered to maximize material recovery while minimizing energy consumption per tonne processed.</div>
          <div class="eco-badge">
            <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#22C55E" stroke-width="2.5"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"></path></svg>
              ...
              <div class="clients-track" id="clientsTrack">
                <article class="client-logo-card">
                  <div class="client-logo-mark">
                    <img src="/images/logo/Uflex-Logo.webp" alt="Uflex Limited logo" class="client-logo" />
                  </div>
                ...
                <article class="client-logo-card">
                  <div class="client-logo-mark">
                    <img src="/images/logo/HSIL Limited.webp" alt="HSIL Limited logo" class="client-logo" />
                  </div>
                ...
                <article class="client-logo-card">
                  <div class="client-logo-mark">
                    <img src="/images/logo/Bengal India Global Infrastructure ltd..webp" alt="Bengal India Global Infrastructure ltd. logo" class="client-logo" />
                  </div>
                ...
                <article class="client-logo-card">
                  <div class="client-logo-mark">
                    <img src="/images/logo/Annapoorna Metal Industries.webp" alt="Annapoorna Metal Industries logo" class="client-logo" />
                  </div>
                ...
                <article class="client-logo-card">
                  <div class="client-logo-mark">
                    <img src="/images/logo/Asian Colour Coates Ispat Ltd.webp" alt="Asian Colour Coates Ispat Ltd logo" class="client-logo" />
                  </div>
                ...
                <article class="client-logo-card">
                  <div class="client-logo-mark">
                    <img src="/images/logo/Forech India ltd.webp" alt="Forech India ltd logo" class="client-logo" />
                  </div>
                ...
                <article class="client-logo-card">
                  <div class="client-logo-mark">
                    <img src="/images/logo/Montage Enterprises Pvt Ltd.webp" alt="Montage Enterprises Pvt Ltd logo" class="client-logo" />
                  </div>
                ...
                <article class="client-logo-card">
                  <div class="client-logo-mark">
                    <img src="/images/logo/Raashi Industries Pvt. Ltd.webp" alt="Raashi Industries Pvt. Ltd logo" class="client-logo" />
                  </div>
                ...
                <article class="client-logo-card">
                  <div class="client-logo-mark">
                    <img src="/images/logo/Vardhman Polymers Pvt. Ltd.webp" alt="Vardhman Polymers Pvt. Ltd logo" class="client-logo" />
                  </div>
                ...
                <article class="client-logo-card">
                  <div class="client-logo-mark">
                    <img src="/images/logo/Sudha Ventilating Systems Pvt Ltd.webp" alt="Sudha Ventilating Systems Pvt Ltd logo" class="client-logo" />
                  </div>
                ...
                <article class="client-logo-card">
                  <div class="client-logo-mark">
                    <img src="/images/logo/IAC Internationa Automotive India Pvt Ltd.webp" alt="IAC International Automotive India Pvt Ltd logo" class="client-logo" />
                  </div>
                ...
                <article class="client-logo-card">
                  <div class="client-logo-mark">
                    <img src="/images/logo/TAJ Forging Private LTD.webp" alt="TAJ Forging Private LTD logo" class="client-logo" />
                  </div>
                ...
                <article class="client-logo-card">
                  <div class="client-logo-mark">
                    <img src="/images/logo/Arihant Publication.webp" alt="Arihant Publication logo" class="client-logo" />
                  </div>
                ...
                <article class="client-logo-card">
                  <div class="client-logo-mark">
                    <img src="/images/logo/RSPL Limited.webp" alt="RSPL Limited logo" class="client-logo" />
                  </div>
                ...
                <article class="client-logo-card">
                  <div class="client-logo-mark">
                    <img src="/images/logo/Hindustan Motors.webp" alt="Hindustan Motors logo" class="client-logo" />
                  </div>
                ...
                <article class="client-logo-card">
                  <div class="client-logo-mark">
                    <img src="/images/logo/Uni Products India Ltd.webp" alt="Uni Products India Ltd logo" class="client-logo" />
                  </div>
                ...
                <article class="client-logo-card">
                  <div class="client-logo-mark">
                    <img src="/images/logo/Laxmi Machine Tools.webp" alt="Laxmi Machine Tools logo" class="client-logo" />
                  </div>
                ...
                <article class="client-logo-card">
                  <div class="client-logo-mark">
                    <img src="/images/logo/Sree Rayalaseema HiStrength Hypo Limited.webp" alt="Sree Rayalaseema HiStrength Hypo Limited logo" class="client-logo" />
                  </div>
                ...
                <article class="client-logo-card">
                  <div class="client-logo-mark">
                    <img src="/images/logo/Metso India Pvt. Ltd.webp" alt="Metso India Pvt. Ltd logo" class="client-logo" />
                  </div>
                ...
                <article class="client-logo-card">
                  <div class="client-logo-mark">
                    <img src="/images/logo/Janki Corp Limited.webp" alt="Janki Corp Limited logo" class="client-logo" />
                  </div>
                ...
                <article class="client-logo-card">
                  <div class="client-logo-mark">
                    <img src="/images/logo/Cold Steel Corporation.webp" alt="Cold Steel Corporation logo" class="client-logo" />
                  </div>
                ...
                <article class="client-logo-card">
                  <div class="client-logo-mark">
                    <img src="/images/logo/Hindustan Media Limited.webp" alt="Hindustan Media Limited logo" class="client-logo" />
                  </div>
                ...
                <article class="client-logo-card">
                  <div class="client-logo-mark">
                    <img src="/images/logo/Attero Recycling Ltd.webp" alt="Attero Recycling Ltd logo" class="client-logo" />
                  </div>
    ...
    <div class="inquiry-inner">
      <div class="inquiry-left">
        ...
        <div class="inquiry-trust">
          ...
          <div class="itrust-item">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><polyline points="20 6 9 17 4 12"></polyline></svg>
            Detailed quotation with ROI estimate
          </div>
        </div>
      </div>
          ...
          <form name="machinery-inquiry" action="https://formspree.io/f/xwleradq" method="POST">
            <div class="form-grid">
              ...
              <div class="form-group full">
                ...
                <textarea id="project_details" name="project_details" placeholder="Briefly describe your project, site conditions, or any specific requirements..." rows="4"></textarea>
              </div>
            </div>
            <button type="submit" class="form-submit">Submit Engineering Inquiry</button>
          </form>
        </div>
      </div>
    </div>
